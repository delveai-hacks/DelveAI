...
const selectedFile = async (e: any) => {
  ...
  try {
    const res = await axios.post(`${api}/pdf/pdf_summarize`, formdata)
    ...
    <div class="w-[55%] mx-auto">
      ...
      <div
        ...
        <div class="w-[80%] h-fit">
          <input placeholder="Enter your prompt..." autocomplete="off" v-model="prompt" id="inputai" type="text"
        ...
        <div class="w-[20%]">
          <div
            ...
            <div class="flex items-center space-x-[30px]">
              ...
              <div class="cursor-pointer" @click="getPrompt">
      ...
      <div v-show="answerSheet"
        ...
        <div v-html="answerPrompt" class="leading-[27px] textPlace pb-[26px]"></div>
      </div>
